...
public abstract class AbstractSpringGlobalMethodSecurityConfiguration
	...
	/**
	 * Allows subclasses to provide a custom {@link AccessDecisionManager}. The
	 * default is a {@link AffirmativeBased} with the following voters:
	 *
	 * <ul>
	 ...
	 *
	 * @return a custom {@link MethodSecurityMetadataSource} that is registered with
	 *         the {@link #methodSecurityMetadataSource()}
	 */
	...
	/**
	 * Allows providing a custom {@link AuthenticationManager}. The default is to
	 * use any authentication mechanisms registered by
	 ...
	 * type.
	 *
	 * @param auth the {@link AuthenticationManagerBuilder} used to register
	...
	/**
	 * Provides the default {@link MethodSecurityMetadataSource} that will be used.
	 * It creates a {@link DelegatingMethodSecurityMetadataSource} based upon
	...
	/**
	 * Creates the {@link PreInvocationAuthorizationAdvice} to be used. The default
	 * is {@link ExpressionBasedPreInvocationAdvice}.
	 *
	 * @return
	 */
	@Bean
	...
	/**
	 * Obtains the attributes from {@link EnableGlobalMethodSecurity} if this class
	 * was imported using the {@link EnableGlobalMethodSecurity} annotation.
	 */
